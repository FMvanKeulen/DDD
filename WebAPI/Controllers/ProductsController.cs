...
{   
    public class ProductsController : Controller
    {
        ...
        public ProductsController(InterfaceProductApp interfaceProduct)
        {
            _InterfaceProductApp = interfaceProduct;
        }
        ...
        public async Task<IActionResult> Create([Bind("Price,Active,Id,Name")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Price,Active,Id,Name")] Product product)
        {
            if (id != product.Id)
            {
                return NotFound();
